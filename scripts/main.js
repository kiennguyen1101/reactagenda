...
$(function() {
    ...
    //if ($('#date_birth').length > 0 && $('#date_birth').prop('type') != 'date') {
...
function SetupCalendar(element, input) {

    //require('./rome-master/src/rome.standalone')
    ...
    input = typeof input !== 'undefined' ? input : 'login';

    rome(element, {
        dateValidator: function (d) {
            var m = moment(d);
            //no sunday and no before current date
            var invalid_date = /*m.day() !== 6 && */m.day() !== 0 && m.isAfter(moment());
            //invalid_date = invalide_date && m.isAfter(moment());
            return invalid_date;
        },
        timeValidator: function (d) {
            var m = moment(d);
            var start = m.clone().hour(7).minute(59).second(59);
            var end = m.clone().hour(17).minute(0).second(1);
            return m.isAfter(start) && m.isBefore(end);
        }
    }).on('data', function (value) {
        var validDate = moment(value);
        var remainder = (30 - validDate.minute()) % 30;
        var validDate = validDate.add(remainder, "minutes");
        //result.value = validDate.isAfter(moment()) ? validDate.format('DD/MM/YYYY HH:mm', 'vi') : '';
        if (validDate.isAfter(moment()) && input) {
            //result.readOnly = false;
            result.value = validDate.format('DD/MM/YYYY HH:mm', 'vi');
            //result.readOnly = true;
            date.value = validDate.format('DD/MM/YYYY', 'vi');
            starttime.value = validDate.format("HH:mm", 'vi');
            endtime.value = validDate.add(30, "minutes").format('HH:mm', 'vi');
        }
...
//      console.log($form.serializeArray());
    $.ajax({
        ...
        data: $form.serializeArray(), // our data object
        ...
        if (data.success) {
            ...
            window.document.getElementById('error').innerHTML = "<p class='col-sm-offset-1 col-sm-10 bg-danger'>" + data.error + "</p>";
    }).fail(function (data) {
...
function setupCKEditor() {
    CKEDITOR.replace('discussions_message', {
        //skin: 'office2013',
        toolbarGroups: [
        ...
        removeButtons: 'Underline,Strike,Subscript,Superscript,Anchor,SpecialChar,Source,Insert Special Character',
